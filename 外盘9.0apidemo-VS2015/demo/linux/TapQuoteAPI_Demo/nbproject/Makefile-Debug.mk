...
${OBJECTDIR}/_ext/1143164949/SimpleEvent.o: ../../code/Demo/Common/SimpleEvent.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../code/TapAPI/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1143164949/SimpleEvent.o ../../code/Demo/Common/SimpleEvent.cpp

${OBJECTDIR}/_ext/1370991913/Demo.o: ../../code/Demo/TapQuoteAPI/Demo.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1370991913
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../code/TapAPI/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1370991913/Demo.o ../../code/Demo/TapQuoteAPI/Demo.cpp

${OBJECTDIR}/_ext/1370991913/Quote.o: ../../code/Demo/TapQuoteAPI/Quote.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1370991913
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../code/TapAPI/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1370991913/Quote.o ../../code/Demo/TapQuoteAPI/Quote.cpp
